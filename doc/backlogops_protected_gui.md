...
* [backlogops\_gui.jira\_rename](#backlogops_gui.jira_rename)
  * [JiraRenamer](#backlogops_gui.jira_rename.JiraRenamer)
    ...
    * [\_rename](#backlogops_gui.jira_rename.JiraRenamer._rename)
    * [\_rename\_worker](#backlogops_gui.jira_rename.JiraRenamer._rename_worker)
...
* [backlogops\_gui.jira\_dialogs](#backlogops_gui.jira_dialogs)
  ...
  * [JiraRankDialog](#backlogops_gui.jira_dialogs.JiraRankDialog)
    ...
    * [\_confirm](#backlogops_gui.jira_dialogs.JiraRankDialog._confirm)
  ...
  * [JiraRenameDialog](#backlogops_gui.jira_dialogs.JiraRenameDialog)
    ...
    * [\_build](#backlogops_gui.jira_dialogs.JiraRenameDialog._build)
    * [\_add\_rename\_row](#backlogops_gui.jira_dialogs.JiraRenameDialog._add_rename_row)
    * [\_renames](#backlogops_gui.jira_dialogs.JiraRenameDialog._renames)
    * [\_confirm](#backlogops_gui.jira_dialogs.JiraRenameDialog._confirm)
  ...
  * [JiraOrderDialog](#backlogops_gui.jira_dialogs.JiraOrderDialog)
    ...
    * [\_build](#backlogops_gui.jira_dialogs.JiraOrderDialog._build)
    * [\_build\_names](#backlogops_gui.jira_dialogs.JiraOrderDialog._build_names)
    * [\_names](#backlogops_gui.jira_dialogs.JiraOrderDialog._names)
    * [\_confirm](#backlogops_gui.jira_dialogs.JiraOrderDialog._confirm)
...
* [backlogops\_gui.jira\_base](#backlogops_gui.jira_base)
  * [JiraAction](#backlogops_gui.jira_base.JiraAction)
    ...
    * [\_preset\_filters](#backlogops_gui.jira_base.JiraAction._preset_filters)
...
* [backlogops\_gui.application](#backlogops_gui.application)
  ...
  * [BacklogApp](#backlogops_gui.application.BacklogApp)
    ...
    * [\_file\_source](#backlogops_gui.application.BacklogApp._file_source)
    * [\_file\_reload](#backlogops_gui.application.BacklogApp._file_reload)
...
* [backlogops\_gui.jira\_read](#backlogops_gui.jira_read)
  * [JiraReader](#backlogops_gui.jira_read.JiraReader)
    ...
    * [\_read](#backlogops_gui.jira_read.JiraReader._read)
    * [\_worker](#backlogops_gui.jira_read.JiraReader._worker)
    * [\_open\_new](#backlogops_gui.jira_read.JiraReader._open_new)
    * [\_reload](#backlogops_gui.jira_read.JiraReader._reload)
...
* [backlogops\_gui.backlog\_window](#backlogops_gui.backlog_window)
  ...
  * [BacklogWindow](#backlogops_gui.backlog_window.BacklogWindow)
    ...
    * [\_changed\_refresh](#backlogops_gui.backlog_window.BacklogWindow._changed_refresh)
    * [\_render\_warning](#backlogops_gui.backlog_window.BacklogWindow._render_warning)
    * [\_add\_info](#backlogops_gui.backlog_window.BacklogWindow._add_info)
    * [\_time\_text](#backlogops_gui.backlog_window.BacklogWindow._time_text)
    * [\_detail\_text](#backlogops_gui.backlog_window.BacklogWindow._detail_text)
    * [\_file\_detail](#backlogops_gui.backlog_window.BacklogWindow._file_detail)
    * [\_mark\_text](#backlogops_gui.backlog_window.BacklogWindow._mark_text)
    * [\_set\_modified](#backlogops_gui.backlog_window.BacklogWindow._set_modified)
    * [\_read\_again](#backlogops_gui.backlog_window.BacklogWindow._read_again)
    * [\_confirm\_discard](#backlogops_gui.backlog_window.BacklogWindow._confirm_discard)
    * [\_apply\_reloaded](#backlogops_gui.backlog_window.BacklogWindow._apply_reloaded)
    * [\_rebuild\_body](#backlogops_gui.backlog_window.BacklogWindow._rebuild_body)
    ...
    * [\_rank\_jira](#backlogops_gui.backlog_window.BacklogWindow._rank_jira)
    * [\_on\_ranked](#backlogops_gui.backlog_window.BacklogWindow._on_ranked)
    * [\_releases\_order](#backlogops_gui.backlog_window.BacklogWindow._releases_order)
    * [\_on\_releases\_ordered](#backlogops_gui.backlog_window.BacklogWindow._on_releases_ordered)
    * [\_releases\_rename](#backlogops_gui.backlog_window.BacklogWindow._releases_rename)
    * [\_on\_releases\_renamed](#backlogops_gui.backlog_window.BacklogWindow._on_releases_renamed)
...
* [backlogops\_gui.wizard\_form](#backlogops_gui.wizard_form)
  ...
  * [\_path\_input](#backlogops_gui.wizard_form._path_input)
  * [\_yes\_no\_input](#backlogops_gui.wizard_form._yes_no_input)
  ...
  * [\_path\_value](#backlogops_gui.wizard_form._path_value)
  * [\_choice\_value](#backlogops_gui.wizard_form._choice_value)
  * [\_multi\_selected](#backlogops_gui.wizard_form._multi_selected)
  * [\_multi\_values](#backlogops_gui.wizard_form._multi_values)
  * [\_int\_error](#backlogops_gui.wizard_form._int_error)
  ...
  * [FormEditor](#backlogops_gui.wizard_form.FormEditor)
    ...
    * [\_validator\_blocks](#backlogops_gui.wizard_form.FormEditor._validator_blocks)
    * [\_changed](#backlogops_gui.wizard_form.FormEditor._changed)
    * [\_feedback](#backlogops_gui.wizard_form.FormEditor._feedback)
    * [\_run\_validator](#backlogops_gui.wizard_form.FormEditor._run_validator)
    * [\_first\_error](#backlogops_gui.wizard_form.FormEditor._first_error)
    * [\_apply\_disabled](#backlogops_gui.wizard_form.FormEditor._apply_disabled)
    * [\_show](#backlogops_gui.wizard_form.FormEditor._show)
    * [\_read](#backlogops_gui.wizard_form.FormEditor._read)
    * [\_field\_error](#backlogops_gui.wizard_form.FormEditor._field_error)
...
* [backlogops\_gui.jira\_order](#backlogops_gui.jira_order)
  * [JiraOrderer](#backlogops_gui.jira_order.JiraOrderer)
    ...
    * [\_order](#backlogops_gui.jira_order.JiraOrderer._order)
    * [\_wanted\_names](#backlogops_gui.jira_order.JiraOrderer._wanted_names)
    * [\_order\_worker](#backlogops_gui.jira_order.JiraOrderer._order_worker)
...
* [backlogops\_gui.wizard\_path](#backlogops_gui.wizard_path)
  ...
  * [\_path\_error](#backlogops_gui.wizard_path._path_error)
  * [\_path\_exists](#backlogops_gui.wizard_path._path_exists)
  * [\_must\_exist](#backlogops_gui.wizard_path._must_exist)
  * [\_must\_not\_exist](#backlogops_gui.wizard_path._must_not_exist)
  * [\_must\_be\_file](#backlogops_gui.wizard_path._must_be_file)
  * [\_must\_be\_dir](#backlogops_gui.wizard_path._must_be_dir)
  * [\_is\_dir\_kind](#backlogops_gui.wizard_path._is_dir_kind)
  * [pick\_path](#backlogops_gui.wizard_path.pick_path)
  * [\_start\_location](#backlogops_gui.wizard_path._start_location)
  * [\_open\_dialog](#backlogops_gui.wizard_path._open_dialog)
...
* [backlogops\_gui.wizard\_window](#backlogops_gui.wizard_window)
  * [\_default\_path\_text](#backlogops_gui.wizard_window._default_path_text)
  * [WizardWindow](#backlogops_gui.wizard_window.WizardWindow)
    ...
    * [\_run\_int](#backlogops_gui.wizard_window.WizardWindow._run_int)
    * [ask\_path](#backlogops_gui.wizard_window.WizardWindow.ask_path)
    * [\_run\_path](#backlogops_gui.wizard_window.WizardWindow._run_path)
...
<a id="backlogops_gui.jira_rename.JiraRenamer._rename"></a>

#### \_rename

```python
def _rename(data: BacklogReleases, on_done: Callable[[RenamedReleasesInJira],
                                                     None]) -> None
```

Ask for a preset and new names, then rename in Jira.

<a id="backlogops_gui.jira_rename.JiraRenamer._rename_worker"></a>

#### \_rename\_worker

```python
def _rename_worker(options: JiraRenameOptions,
...
<a id="backlogops_gui.jira_dialogs.JiraRankDialog._build"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraRankDialog._build_filter"></a>
...
```python
def _build_keys() -> tk.Text
```

Add the key entry label, text box and load-from-file button.

<a id="backlogops_gui.jira_dialogs.JiraRankDialog._preset_changed"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraRankDialog._load"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraRankDialog._confirm"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraRenameDialog._build"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraRenameDialog._add_rename_row"></a>

#### \_add\_rename\_row

```python
def _add_rename_row(name: str) -> None
```

Add one labelled new-name entry for the release ``name``.

<a id="backlogops_gui.jira_dialogs.JiraRenameDialog._renames"></a>

#### \_renames

```python
def _renames() -> list[ReleaseRename]
```

Return a rename for each entry that changes the release name.

<a id="backlogops_gui.jira_dialogs.JiraRenameDialog._confirm"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraOrderDialog._build"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraOrderDialog._build_names"></a>

#### \_build\_names

```python
def _build_names() -> tk.Text
```

Add the name entry box used by the by-names order source.

<a id="backlogops_gui.jira_dialogs.JiraOrderDialog._names"></a>
...
<a id="backlogops_gui.jira_dialogs.JiraOrderDialog._confirm"></a>
...
<a id="backlogops_gui.jira_base.JiraAction._preset_filters"></a>
...
<a id="backlogops_gui.application.BacklogApp._file_source"></a>
...
def _file_source(
        ...
        presets: Optional[dict[str, InputFormatConfig]]) -> BacklogSource
```

Describe a file backlog source, naming a preset when used.

<a id="backlogops_gui.application.BacklogApp._file_reload"></a>
...
def _file_reload(
    path: str, value: Optional[str]
) -> Callable[[Callable[[BacklogReleases, Optional[str]], None]], None]
```
...
<a id="backlogops_gui.jira_rank.JiraRanker._rank"></a>

#### \_rank

```python
def _rank(on_done: Callable[[RankedInJira], None]) -> None
```

Ask for a preset, filter, keys and end, then rank in Jira.

<a id="backlogops_gui.jira_rank.JiraRanker._rank_worker"></a>

#### \_rank\_worker

```python
def _rank_worker(options: JiraRankOptions, on_done: Callable[[RankedInJira],
                                                             None]) -> None
```
...
<a id="backlogops_gui.jira_read.JiraReader._read"></a>

#### \_read

```python
def _read(
    name: str, issue_filter: str,
    deliver: Callable[[str, str, BacklogReleases, Optional[str]],
                      None]) -> None
```
...
<a id="backlogops_gui.jira_read.JiraReader._worker"></a>
...
<a id="backlogops_gui.jira_read.JiraReader._open_new"></a>

#### \_open\_new

```python
def _open_new(name: str, issue_filter: str, data: BacklogReleases,
              warning: Optional[str]) -> None
```

Open a new window on the Jira data and report the read.

<a id="backlogops_gui.jira_read.JiraReader._reload"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._changed_refresh"></a>

#### \_changed\_refresh

```python
def _changed_refresh() -> None
```

Mark the backlog modified and rebuild the tables.

<a id="backlogops_gui.backlog_window.BacklogWindow._render_warning"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._add_info"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._time_text"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._detail_text"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._file_detail"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._mark_text"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._set_modified"></a>

#### \_set\_modified

```python
def _set_modified(modified: bool) -> None
```

Set the modified flag and update the info-region marker.

<a id="backlogops_gui.backlog_window.BacklogWindow._read_again"></a>

#### \_read\_again

```python
def _read_again() -> None
```

Re-read from the same source, confirming loss of any changes.

<a id="backlogops_gui.backlog_window.BacklogWindow._confirm_discard"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._apply_reloaded"></a>

#### \_apply\_reloaded

```python
def _apply_reloaded(data: BacklogReleases, warning: Optional[str]) -> None
```

Replace the shown data after a re-read and refresh the window.

<a id="backlogops_gui.backlog_window.BacklogWindow._rebuild_body"></a>

#### \_rebuild\_body

```python
def _rebuild_body(was_restricted: bool) -> None
```
...
<a id="backlogops_gui.backlog_window.BacklogWindow._saved_to_source"></a>

#### \_saved\_to\_source

```python
def _saved_to_source(path: str) -> bool
```
...
<a id="backlogops_gui.backlog_window.BacklogWindow._rank_jira"></a>
...
<a id="backlogops_gui.backlog_window.BacklogWindow._on_ranked"></a>

#### \_on\_ranked

```python
def _on_ranked(result: RankedInJira) -> None
```
...
<a id="backlogops_gui.backlog_window.BacklogWindow._releases_order"></a>

#### \_releases\_order

```python
def _releases_order() -> None
```

Order the releases in Jira and show the result lists.

<a id="backlogops_gui.backlog_window.BacklogWindow._on_releases_ordered"></a>

#### \_on\_releases\_ordered

```python
def _on_releases_ordered(result: OrderedReleasesInJira) -> None
```
...
<a id="backlogops_gui.backlog_window.BacklogWindow._releases_rename"></a>

#### \_releases\_rename

```python
def _releases_rename() -> None
```

Rename the shown releases in Jira and show the result lists.

<a id="backlogops_gui.backlog_window.BacklogWindow._on_releases_renamed"></a>

#### \_on\_releases\_renamed

```python
def _on_releases_renamed(result: RenamedReleasesInJira) -> None
```
...
<a id="backlogops_gui.wizard_form._Input"></a>
...
<a id="backlogops_gui.wizard_form._int_input"></a>
...
<a id="backlogops_gui.wizard_form._path_input"></a>
...
<a id="backlogops_gui.wizard_form._yes_no_input"></a>
...
<a id="backlogops_gui.wizard_form._choice_input"></a>
...
<a id="backlogops_gui.wizard_form._multi_input"></a>
...
<a id="backlogops_gui.wizard_form._preselect"></a>
...
<a id="backlogops_gui.wizard_form._entry_widget"></a>
...
<a id="backlogops_gui.wizard_form._int_value"></a>
...
<a id="backlogops_gui.wizard_form._path_value"></a>
...
<a id="backlogops_gui.wizard_form._choice_value"></a>
...
<a id="backlogops_gui.wizard_form._multi_selected"></a>
...
<a id="backlogops_gui.wizard_form._multi_values"></a>
...
<a id="backlogops_gui.wizard_form._int_error"></a>
...
<a id="backlogops_gui.wizard_form._multi_error"></a>
...
<a id="backlogops_gui.wizard_form._set_widget_state"></a>
...
<a id="backlogops_gui.wizard_form._enable_row"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._validator_blocks"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._changed"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._feedback"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._run_validator"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._first_error"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._apply_disabled"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._show"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._read"></a>
...
<a id="backlogops_gui.wizard_form.FormEditor._field_error"></a>
...
<a id="backlogops_gui.jira_order.JiraOrderer._order"></a>

#### \_order

```python
def _order(data: BacklogReleases, on_done: Callable[[OrderedReleasesInJira],
                                                    None]) -> None
```

Ask for a preset and order source, then order in Jira.

<a id="backlogops_gui.jira_order.JiraOrderer._wanted_names"></a>

#### \_wanted\_names

```python
def _wanted_names(options: JiraOrderOptions,
                  data: BacklogReleases) -> list[str]
```

Return the wanted order of names for a by-name order source.

<a id="backlogops_gui.jira_order.JiraOrderer._order_worker"></a>

#### \_order\_worker

```python
def _order_worker(options: JiraOrderOptions, data: BacklogReleases,
...
<a id="backlogops_gui.wizard_path._path_error"></a>
...
<a id="backlogops_gui.wizard_path._path_exists"></a>
...
<a id="backlogops_gui.wizard_path._must_exist"></a>
...
<a id="backlogops_gui.wizard_path._must_not_exist"></a>
...
<a id="backlogops_gui.wizard_path._must_be_file"></a>
...
<a id="backlogops_gui.wizard_path._must_be_dir"></a>
...
<a id="backlogops_gui.wizard_path._is_dir_kind"></a>
...
<a id="backlogops_gui.wizard_path._start_location"></a>
...
<a id="backlogops_gui.wizard_path._open_dialog"></a>
...
<a id="backlogops_gui.wizard_path.PathRow._browse"></a>
...
<a id="backlogops_gui.wizard_window._default_path_text"></a>
...
<a id="backlogops_gui.wizard_window.WizardWindow._run_int"></a>
...
<a id="backlogops_gui.wizard_window.WizardWindow._run_path"></a>
