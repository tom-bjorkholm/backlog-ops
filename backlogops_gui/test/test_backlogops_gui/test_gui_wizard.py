...
def _bridge(ask_fn: Optional[Callable[
                ...
                str | int]] = None,
            show_fn: Optional[Callable[[str], None]] = None) -> TkWizardBridge:
    """Return a bridge over a dummy parent with injected callables."""
    return TkWizardBridge(cast(tk.Misc, object()), ask_fn, show_fn)
...
def test_error_file_is_sink() -> None:
    """Test the diagnostics stream discards its output."""
