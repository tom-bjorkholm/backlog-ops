...
from backlogops_gui.file_choosers import (
    choose_changes_output, choose_config_file, choose_config_to_edit,
    choose_existing_config, choose_existing_preset, choose_input_file,
    choose_key_list_output, choose_migrated_preset, choose_output_file,
    choose_preset_to_edit, choose_preset_to_migrate)
...
CHOOSERS: list[tuple[Callable[[tk.Misc], Optional[str]], str]] = [
    ...
    (choose_config_to_edit, 'askopenfilename'),
    (choose_preset_to_edit, 'askopenfilename')]
